...
- (void)sendAccessLog {
    [RequestService sendRecordAccessLogWithEquipModel:[DeviceModel getCurrentDeviceModel] andModuleId:[self.dataDict objectForKey:@"kpiCode"] andInterfaceName:@"NULL"];
}
...
- (void)showWebView {
    ...
    NSString *mobilechargingHtmlPath = [documentPath stringByAppendingString:@"/jkyb-zdgzzb-report.html"];
    ...
    if ([fileManager fileExistsAtPath:mobilechargingHtmlPath]) {
        ...
        NSString *filePath = [[NSBundle mainBundle] pathForResource:@"jkyb-zdgzzb-report" ofType:@"html"];
